...
public class day02b {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < passwordAL.size(); i++) {
            String firstPos = String.valueOf(passwordAL.get(i).charAt(minAL.get(i) - 1));
            String secondPos = String.valueOf(passwordAL.get(i).charAt(maxAL.get(i) - 1));

            if (letterAL.get(i).equals(firstPos) && !(letterAL.get(i).equals(secondPos))) {
                total++;
            } else if (!(letterAL.get(i).equals(firstPos)) && letterAL.get(i).equals(secondPos)) {
                total++;
            }
        }
